...
password = ''.join(random.choices('abcdefghijkmnopqrstuvwxyz1234567890', k=8)) # k attribute mean we gie a number there and it will make that number of choices e enter in the k
print(password)
